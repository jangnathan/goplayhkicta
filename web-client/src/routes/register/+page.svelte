		...
		<button type="button" class="nsg-button" onclick={handleGoogleSignIn} disabled={loading}>
			<div class="nsg-icon-wrapper">
				<svg class="nsg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
					...
					<path
						fill="#4285F4"
						d="M46.5 24c0-1.55-.15-3.24-.47-4.77H24v9.03h12.75c-.55 2.85-2.17 5.27-4.59 6.89l7.14 5.53C43.51 36.12 46.5 30.68 46.5 24z"
					/>
					<path
						fill="#FBBC05"
					...
					<path
						fill="#34A853"
						d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.14-5.53c-1.97 1.32-4.5 2.11-8.75 2.11-6.26 0-11.57-4.22-13.46-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"
					/>
				</svg>
			</div>
...
<style>
	...
	.input-group input:focus {
		...
		box-shadow: 0 0 0 2px rgba(255, 59, 43, 0.15);
	}
	.input-help {
		font-size: 12px;
		color: var(--text-muted);
